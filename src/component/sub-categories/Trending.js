...
// export default function Trending({ categories, showingTranslateValue }) {
...
//                 {showingTranslateValue(categories[0]?.children[2]?.name)}
//               </h2>
//             </div>
//           </div>
...
//                 {categories[0]?.children[2]?.children
//                   .slice(0, 6)
//                   .map((category, index) => {
//                     return (
//                       <Link
...
//                         className="bg-white my-5 md:my-0 shadow-xl w-[200px] h-auto rounded-lg overflow-hidden"
//                       >
//                         <Image
//                           width={400}
//                           height={300}
...
//               {categories[0]?.children[2]?.children.length > 6 ? (
//                 <Link
//                   href={`/showsuballcatagory/${categories[0]?.children[2]?._id}`}
