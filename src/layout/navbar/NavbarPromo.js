                ...
                <div className="flex justify-between items-center md:justify-start md:space-x-10">
                  ...
                  >
                    {storeCustomizationSetting?.navbar?.categories_menu_status && (
                      ...
                      <Popover className="relative font-serif rounded-md p-0.5 py-0 px-1" style={{ backgroundColor: "#10B981" }}>
                        ...
                        >
                          <Popover.Panel className="absolute z-10 -ml-1 mt-1 transform w-screen max-w-xs c-h-65vh bg-green">
